    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            public void onStateChanged(View v, int newState) {
                switch (newState) {
                    case ThreeStateButton.STATE_UNKNOWN:
                        mSource.enableTempReport = null;
                        break;
                    case ThreeStateButton.STATE_NO:
                        mSource.enableTempReport = false;
                        break;
                    case ThreeStateButton.STATE_YES:
                        mSource.enableTempReport = true;
                        break;
                }
            }
        });
        mInfoReport.setOnStateChangedListener(new ThreeStateButton.OnStateChangedListener() {
            ...
            public void onStateChanged(View v, int newState) {
                switch (newState) {
                    case ThreeStateButton.STATE_UNKNOWN:
                        mSource.enableInfoReport = null;
                        break;
                    case ThreeStateButton.STATE_NO:
                        mSource.enableInfoReport = false;
                        break;
                    case ThreeStateButton.STATE_YES:
                        mSource.enableInfoReport = true;
                        break;
                }
            }
        });
