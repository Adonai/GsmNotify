...
/**
 * Shows and archives history for power outages
 * 
 * @author Oleg Chernovskiy
 * TODO: refactor these damn fragments to one!
 */
public class PowerHistoryListFragment extends DialogFragment {
    SimpleDateFormat sdf = new SimpleDateFormat("dd.MM.yyyy HH:mm:ss", Locale.getDefault());

    private ListView mListView;

    public PowerHistoryListFragment() {
    }

    public static PowerHistoryListFragment newInstance() {
        PowerHistoryListFragment hlf = new PowerHistoryListFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PowerHistoryListFragment.this.dismiss();
            }
        });
